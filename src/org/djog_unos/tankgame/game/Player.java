...
public class Player
{
    ...
    public void update()
    {
        ...
        turret.setRotation(((shortest_angle * turret.getRotation_speed()) % 360) * (float)Game.getDeltaTime());
        ...
        if (InputManager.isMouseButtonDown(0) && m_fireCountdown <= 0.0f && !m_buttonDown)
        {
            ...
            m_shells.add(new Shell(shellPosition.x, shellPosition.y + 12, turret.getRotation() * (PI / 180), shellTarget));
        }
